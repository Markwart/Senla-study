...
public class ExceptionHandlerController extends ResponseEntityExceptionHandler {
	...
	private static final String METHOD_NOT_ALLOWED = "Request Method not supported ";
	...
	public ResponseEntity<Object> handleUsernameNotFoundException(UsernameNotFoundException ex, WebRequest request) {
		LOGGER.log(Level.WARN, EXCEPTION, ex);
		ApiError apiError = new ApiError(HttpStatus.NOT_FOUND, USER_NOT_FOUND, ex.getMessage());
		return new ResponseEntity<Object>(apiError, HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<Object> handleBadCredentialsException(BadCredentialsException ex, WebRequest request) {
		LOGGER.log(Level.WARN, EXCEPTION, ex);
		ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, PASSWORD, ex.getMessage());
		return new ResponseEntity<Object>(apiError, HttpStatus.BAD_REQUEST);
	}
}
